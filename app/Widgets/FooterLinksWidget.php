        ...
        <div class="footer-links-widget-form" data-field-prefix="<?php echo esc_attr($field_name); ?>">
            <p>
                ...
                <input class="widefat" 
                       ...
                       placeholder="<?php _e('e.g., Contact, Navigate, Support', 'sage'); ?>">
            </p>
            
            <p style="margin-bottom: 8px;"><strong><?php _e('Items:', 'sage'); ?></strong></p>
                ...
                <?php foreach ($items as $index => $item): ?>
                    <div class="footer-link-item" style="margin-bottom: 10px; padding: 10px; border: 1px solid #ddd; border-radius: 4px; background: #f9f9f9;">
                        <div style="margin-bottom: 8px;">
                            <label style="display: block; margin-bottom: 4px; font-weight: 600;"><?php _e('Text:', 'sage'); ?></label>
                            <input type="text" 
                                   class="widefat footer-link-text" 
                                   name="<?php echo esc_attr($field_name); ?>[<?php echo $index; ?>][text]" 
                                   value="<?php echo esc_attr($item['text'] ?? ''); ?>"
                                   placeholder="<?php _e('Display text', 'sage'); ?>">
                        </div>
                        <div style="margin-bottom: 8px;">
                            <label style="display: block; margin-bottom: 4px; font-weight: 600;"><?php _e('URL (optional - leave empty for plain text):', 'sage'); ?></label>
                            <input type="url" 
                        ...
                        <div style="margin-bottom: 8px;">
                            <label>
                                ...
                                <?php _e('Open in new tab', 'sage'); ?>
                            </label>
                        </div>
                        <div style="text-align: right;">
                            <button type="button" class="button button-link button-link-delete footer-remove-link" style="color: #b32d2e;"><?php _e('Delete', 'sage'); ?></button>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
            ...
            <p>
                <button type="button" 
                        ...
                        data-widget-id="<?php echo $widget_id; ?>"><?php _e('+ Add Item', 'sage'); ?></button>
            </p>
        </div>
        <?php
    }
