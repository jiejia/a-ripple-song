...
{
    /**
     * Default light theme slug.
     */
    public const DEFAULT_LIGHT_THEME = 'retro';

    /**
     * Default dark theme slug.
     */
    public const DEFAULT_DARK_THEME = 'dim';
    ...
    {
        return [
            'retro' => __('retro', 'a-ripple-song'),
            'pastel-breeze' => __('Pastel Breeze', 'a-ripple-song'),
            'soft-sand' => __('Soft Sand', 'a-ripple-song'),
            'mint-cream' => __('Mint Cream', 'a-ripple-song'),
            'blush-mist' => __('Blush Mist', 'a-ripple-song'),
            'sky-peach' => __('Sky Peach', 'a-ripple-song'),
            'lemon-fizz' => __('Lemon Fizz', 'a-ripple-song'),
            'lavender-fog' => __('Lavender Fog', 'a-ripple-song'),
            'coral-sunset' => __('Coral Sunset', 'a-ripple-song'),
            'sea-glass' => __('Sea Glass', 'a-ripple-song'),
            'apricot-sorbet' => __('Apricot Sorbet', 'a-ripple-song'),
            'cotton-candy' => __('Cotton Candy', 'a-ripple-song'),
            'pear-spritz' => __('Pear Spritz', 'a-ripple-song'),
            'cloud-latte' => __('Cloud Latte', 'a-ripple-song'),
            'dew-frost' => __('Dew Frost', 'a-ripple-song'),
            'peach-foam' => __('Peach Foam', 'a-ripple-song'),
            'lilac-ice' => __('Lilac Ice', 'a-ripple-song'),
            'sage-mint' => __('Sage Mint', 'a-ripple-song'),
            'buttercup' => __('Buttercup', 'a-ripple-song'),
            'powder-blue' => __('Powder Blue', 'a-ripple-song'),
            'melon-ice' => __('Melon Ice', 'a-ripple-song'),
            'hazy-rose' => __('Hazy Rose', 'a-ripple-song'),
            'calm-water' => __('Calm Water', 'a-ripple-song'),
            'honey-milk' => __('Honey Milk', 'a-ripple-song'),
            'arctic-mint' => __('Arctic Mint', 'a-ripple-song'),
            'vanilla-berry' => __('Vanilla Berry', 'a-ripple-song'),
            'morning-sun' => __('Morning Sun', 'a-ripple-song'),
            'matcha-cream' => __('Matcha Cream', 'a-ripple-song'),
        ];
    }
    ...
    {
        return [
            'dim' => __('dim', 'a-ripple-song'),
            'midnight-aurora' => __('Midnight Aurora', 'a-ripple-song'),
            'neon-plasma' => __('Neon Plasma', 'a-ripple-song'),
            'cyber-grape' => __('Cyber Grape', 'a-ripple-song'),
            'velvet-ember' => __('Velvet Ember', 'a-ripple-song'),
            'ink-cyan' => __('Ink Cyan', 'a-ripple-song'),
            'dusk-rose' => __('Dusk Rose', 'a-ripple-song'),
            'obsidian-gold' => __('Obsidian Gold', 'a-ripple-song'),
            'deep-space' => __('Deep Space', 'a-ripple-song'),
            'ocean-night' => __('Ocean Night', 'a-ripple-song'),
            'noir-mint' => __('Noir Mint', 'a-ripple-song'),
            'plum-neon' => __('Plum Neon', 'a-ripple-song'),
            'cobalt-flare' => __('Cobalt Flare', 'a-ripple-song'),
            'dusk-marine' => __('Dusk Marine', 'a-ripple-song'),
            'ember-glow' => __('Ember Glow', 'a-ripple-song'),
            'midnight-teal' => __('Midnight Teal', 'a-ripple-song'),
            'aurora-mist' => __('Aurora Mist', 'a-ripple-song'),
            'shadow-berry' => __('Shadow Berry', 'a-ripple-song'),
            'neon-blush' => __('Neon Blush', 'a-ripple-song'),
            'abyss-blue' => __('Abyss Blue', 'a-ripple-song'),
            'charcoal-mint' => __('Charcoal Mint', 'a-ripple-song'),
            'galaxy-candy' => __('Galaxy Candy', 'a-ripple-song'),
            'violet-storm' => __('Violet Storm', 'a-ripple-song'),
            'magma-ice' => __('Magma Ice', 'a-ripple-song'),
            'stormy-sea' => __('Stormy Sea', 'a-ripple-song'),
            'lunar-mauve' => __('Lunar Mauve', 'a-ripple-song'),
            'acid-jungle' => __('Acid Jungle', 'a-ripple-song'),
            'carbon-ember' => __('Carbon Ember', 'a-ripple-song'),
        ];
    }
