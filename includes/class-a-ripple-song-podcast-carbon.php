...
class A_Ripple_Song_Podcast_Carbon_Compat {
	...
	private static function resolve_class( ...$candidates ) {
		...
		$plugin_booted = did_action( 'carbon_fields_loaded' ) && class_exists( '\\A_Ripple_Song_Podcast\\Vendor\\Carbon_Fields\\Carbon_Fields', false );
...
class A_Ripple_Song_Podcast_Carbon {
	 ...
	 * @return void
	 */
	public function boot_if_needed() {
