...
<h3 align="center">適用於播客與部落格的現代 WordPress 主題</h3>
...
> **為速度而生的現代主題。**  
> 播放器、小工具、i18n、分析與絲滑的頁面導覽——打磨到像產品一樣好用。

## ✨ 內建功能

| 功能 | 說明 |
|------|------|
| 🎙️ **播客友善 UI** | 集數樣板、小工具與播放器介面（需搭配外掛） |
| 🎵 **沉浸式音訊體驗** | 全站常駐播放器、波形視覺化、播放清單與完整控制 |
| 🎨 **56 種主題配色** | DaisyUI 主題系統，視覺化挑選器，支援明暗模式 |
| ⚡ **現代技術棧** | Laravel Blade、Tailwind CSS v4、Vite、Alpine.js |
| 🌐 **多語系** | UI 字串已翻譯（見 `resources/lang/`） |
| 📊 **資料追蹤與分析** | 內建指標/統計支援 |
| 🧩 **彈性小工具系統** | 作者、集數、橫幅等多種可自訂小工具 |
| 📱 **行動優先響應式** | 自適應版面，任何裝置都好看 |
| ✨ **無縫頁面轉場** | Swup.js 帶來流暢的頁面過渡 |

---

## 🎙️ 播客支援（需搭配外掛）

此主題**不會**註冊自訂文章類型（CPT）或分類法（taxonomy）。

若要建置播客網站，請安裝外掛 `a-ripple-song-podcast`（會註冊 `ars_episode` 文章類型）。啟用後主題將提供：
...
| 分頁 | 內容 |
|------|------|
| **General** | 網站 Logo、頁腳版權、DaisyUI 主題挑選器 |
| **Social Links** | 頁腳社群連結 |
