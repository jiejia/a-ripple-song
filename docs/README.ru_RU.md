...
A Ripple Song — это плагин подкастов для WordPress, который добавляет публикацию и управление подкастами, а также генерирует Podcast RSS для синхронизации с крупными подкаст-платформами.

<img width="" src="../screenshot.png"/>

## Особенности

- Типы записей и категории для подкастов, упрощающие добавление и управление выпусками
