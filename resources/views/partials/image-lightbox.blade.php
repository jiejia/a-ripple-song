...
<dialog id="image-lightbox-modal" class="modal modal-bottom sm:modal-middle">
  <div class="modal-box max-w-7xl w-full bg-base-100 p-2">
    <form method="dialog">
      <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 z-10" aria-label="{{ __('Close', 'a-ripple-song') }}">✕</button>
    </form>
  ...
  <form method="dialog" class="modal-backdrop">
    <button aria-label="{{ __('Close', 'a-ripple-song') }}">{{ __('Close', 'a-ripple-song') }}</button>
  </form>
</dialog>
