...
<div class="card bg-base-100 w-full mt-4">
    <div class="card-body p-4">
        ...
        <button class="btn bg-black btn-sm text-white border-black">
            <i data-lucide="podcast" class="w-4 h-4"></i>
            Apple Podcast
        </button>
        <button class="btn bg-[#03C755] btn-sm text-white border-[#00b544]">
            <i data-lucide="music" class="w-4 h-4"></i>
            Spotify
        </button>
        <button class="btn bg-[#FEE502] btn-sm text-[#181600] border-[#f1d800]">
