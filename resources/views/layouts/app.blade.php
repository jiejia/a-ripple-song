<!doctype html>
<html @php(language_attributes()) class="bg-base-200" data-theme="{{ esc_attr(\App\Customizers\ThemeColor::getLightTheme()) }}" x-data x-init="$store.theme.init()" :data-theme="$store.theme.current || '{{ esc_attr(\App\Customizers\ThemeColor::getLightTheme()) }}'">
